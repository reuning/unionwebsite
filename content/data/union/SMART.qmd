...
title: SMART
open-graph: 
    title: SMART Union Elections
    description: Data on recent union elections in SMART.
---
...
library(gt)
library(here)
data <- read_csv("SMART_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
