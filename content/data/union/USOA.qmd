...
title: USOA
open-graph: 
    title: USOA Union Elections
    description: Data on recent union elections in USOA.
---
...
library(gt)
library(here)
data <- read_csv("USOA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
