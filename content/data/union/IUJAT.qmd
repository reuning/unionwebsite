...
title: IUJAT
open-graph: 
    title: IUJAT Union Elections
    description: Data on recent union elections in IUJAT.
---
...
library(gt)
library(here)
data <- read_csv("IUJAT_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
