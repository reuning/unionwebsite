...
title: OPEIU
open-graph: 
    title: OPEIU Union Elections
    description: Data on recent union elections in OPEIU.
---
...
library(gt)
library(here)
data <- read_csv("OPEIU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
