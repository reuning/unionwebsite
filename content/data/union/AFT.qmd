...
title: AFT
open-graph: 
    title: American Federation of Teachers Union Elections
    description: Data on recent union elections in American Federation of Teachers.
---
...
library(gt)
library(here)
data <- read_csv("AFT_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
