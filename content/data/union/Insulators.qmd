...
title: Insulators
open-graph: 
    title: Insulators Union Elections
    description: Data on recent union elections in Insulators.
---
...
library(gt)
library(here)
data <- read_csv("Insulators_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-Insulators
...
```{r}
#| label: newly-covered-Insulators
