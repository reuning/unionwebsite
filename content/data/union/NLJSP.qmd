...
title: NLJSP
open-graph: 
    title: NLJSP Union Elections
    description: Data on recent union elections in NLJSP.
---
...
library(gt)
library(here)
data <- read_csv("NLJSP_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
