...
title: IBB
open-graph: 
    title: IBB Union Elections
    description: Data on recent union elections in IBB.
---
...
library(gt)
library(here)
data <- read_csv("IBB_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
