...
title: AFM
open-graph: 
    title: American Federation of Musicians Union Elections
    description: Data on recent union elections in American Federation of Musicians.
---
...
library(gt)
library(here)
data <- read_csv("AFM_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
