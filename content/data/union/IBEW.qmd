...
title: IBEW
open-graph: 
    title: IBEW Union Elections
    description: Data on recent union elections in IBEW.
---
...
library(gt)
library(here)
data <- read_csv("IBEW_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
