...
title: SPFPA
open-graph: 
    title: SPFPA Union Elections
    description: Data on recent union elections in SPFPA.
---
...
library(gt)
library(here)
data <- read_csv("SPFPA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
