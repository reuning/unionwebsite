...
title: URSO
open-graph: 
    title: URSO Union Elections
    description: Data on recent union elections in URSO.
---
...
library(gt)
library(here)
data <- read_csv("URSO_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
