...
title: UAW
open-graph: 
    title: UAW Union Elections
    description: Data on recent union elections in UAW.
---
...
library(gt)
library(here)
data <- read_csv("UAW_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
