...
title: UE
open-graph: 
    title: UE Union Elections
    description: Data on recent union elections in UE.
---
...
library(gt)
library(here)
data <- read_csv("UE_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
