...
title: ILA
open-graph: 
    title: ILA Union Elections
    description: Data on recent union elections in ILA.
---
...
library(gt)
library(here)
data <- read_csv("ILA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
