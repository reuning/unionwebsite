...
title: UBC
open-graph: 
    title: UBC Union Elections
    description: Data on recent union elections in UBC.
---
...
library(gt)
library(here)
data <- read_csv("UBC_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
