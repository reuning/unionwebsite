...
title: NATCA
open-graph: 
    title: NATCA Union Elections
    description: Data on recent union elections in NATCA.
---
...
library(gt)
library(here)
data <- read_csv("NATCA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
