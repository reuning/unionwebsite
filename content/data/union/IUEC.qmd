...
title: IUEC
open-graph: 
    title: IUEC Union Elections
    description: Data on recent union elections in IUEC.
---
...
library(gt)
library(here)
data <- read_csv("IUEC_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
