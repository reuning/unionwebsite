...
title: IUPAT
open-graph: 
    title: IUPAT Union Elections
    description: Data on recent union elections in IUPAT.
---
...
library(gt)
library(here)
data <- read_csv("IUPAT_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
