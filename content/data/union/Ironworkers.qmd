...
title: Ironworkers
open-graph: 
    title: Ironworkers Union Elections
    description: Data on recent union elections in Ironworkers.
---
...
library(gt)
library(here)
data <- read_csv("Ironworkers_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-Ironworkers
...
```{r}
#| label: worker-outcome-Ironworkers
...
```{r}
#| label: newly-covered-Ironworkers
