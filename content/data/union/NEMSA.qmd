...
title: NEMSA
open-graph: 
    title: NEMSA Union Elections
    description: Data on recent union elections in NEMSA.
---
...
library(gt)
library(here)
data <- read_csv("NEMSA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
