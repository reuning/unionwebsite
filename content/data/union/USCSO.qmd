...
title: USCSO
open-graph: 
    title: USCSO Union Elections
    description: Data on recent union elections in USCSO.
---
...
library(gt)
library(here)
data <- read_csv("USCSO_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
