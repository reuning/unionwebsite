...
title: UWA
open-graph: 
    title: UWA Union Elections
    description: Data on recent union elections in UWA.
---
...
library(gt)
library(here)
data <- read_csv("UWA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
