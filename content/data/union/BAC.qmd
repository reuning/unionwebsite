...
title: BAC
open-graph: 
    title: BAC Union Elections
    description: Data on recent union elections in BAC.
---
...
library(gt)
library(here)
data <- read_csv("BAC_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
