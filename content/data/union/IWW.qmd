...
title: IWW
open-graph: 
    title: IWW Union Elections
    description: Data on recent union elections in IWW.
---
...
library(gt)
library(here)
data <- read_csv("IWW_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
