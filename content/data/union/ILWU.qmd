...
title: ILWU
open-graph: 
    title: ILWU Union Elections
    description: Data on recent union elections in ILWU.
---
...
library(gt)
library(here)
data <- read_csv("ILWU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
