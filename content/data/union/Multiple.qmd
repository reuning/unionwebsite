...
title: Multiple
open-graph: 
    title: Multiple Union Elections
    description: Data on recent union elections in Multiple.
---
...
library(gt)
library(here)
data <- read_csv("Multiple_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
