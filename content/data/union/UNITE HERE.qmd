...
title: UNITE HERE
open-graph: 
    title: UNITE HERE Union Elections
    description: Data on recent union elections in UNITE HERE.
---
...
library(gt)
library(here)
data <- read_csv("UNITE HERE_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-UNITE HERE
...
```{r}
#| label: newly-covered-UNITE HERE
