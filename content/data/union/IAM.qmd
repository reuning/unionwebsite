...
title: IAM
open-graph: 
    title: IAM Union Elections
    description: Data on recent union elections in IAM.
---
...
library(gt)
library(here)
data <- read_csv("IAM_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
