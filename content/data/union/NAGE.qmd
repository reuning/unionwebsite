...
title: NAGE
open-graph: 
    title: NAGE Union Elections
    description: Data on recent union elections in NAGE.
---
...
library(gt)
library(here)
data <- read_csv("NAGE_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
