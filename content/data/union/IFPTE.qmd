...
title: IFPTE
open-graph: 
    title: IFPTE Union Elections
    description: Data on recent union elections in IFPTE.
---
...
library(gt)
library(here)
data <- read_csv("IFPTE_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
