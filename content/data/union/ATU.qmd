...
title: ATU
open-graph: 
    title: ATU Union Elections
    description: Data on recent union elections in ATU.
---
...
library(gt)
library(here)
data <- read_csv("ATU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
