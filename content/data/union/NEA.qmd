...
title: NEA
open-graph: 
    title: NEA Union Elections
    description: Data on recent union elections in NEA.
---
...
library(gt)
library(here)
data <- read_csv("NEA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
