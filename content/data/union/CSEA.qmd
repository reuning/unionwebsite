...
title: CSEA
open-graph: 
    title: CSEA Union Elections
    description: Data on recent union elections in CSEA.
---
...
library(gt)
library(here)
data <- read_csv("CSEA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
