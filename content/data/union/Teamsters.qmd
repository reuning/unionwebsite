...
title: Teamsters
open-graph: 
    title: Teamsters Union Elections
    description: Data on recent union elections in Teamsters.
---
...
library(gt)
library(here)
data <- read_csv("Teamsters_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-Teamsters
