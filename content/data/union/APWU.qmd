...
title: APWU
open-graph: 
    title: APWU Union Elections
    description: Data on recent union elections in APWU.
---
...
library(gt)
library(here)
data <- read_csv("APWU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
