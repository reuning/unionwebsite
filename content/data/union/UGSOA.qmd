...
title: UGSOA
open-graph: 
    title: UGSOA Union Elections
    description: Data on recent union elections in UGSOA.
---
...
library(gt)
library(here)
data <- read_csv("UGSOA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
