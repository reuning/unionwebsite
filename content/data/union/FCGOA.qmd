...
title: FCGOA
open-graph: 
    title: FCGOA Union Elections
    description: Data on recent union elections in FCGOA.
---
...
library(gt)
library(here)
data <- read_csv("FCGOA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
