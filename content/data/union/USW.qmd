...
title: USW
open-graph: 
    title: USW Union Elections
    description: Data on recent union elections in USW.
---
...
library(gt)
library(here)
data <- read_csv("USW_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
