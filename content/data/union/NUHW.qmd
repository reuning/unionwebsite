...
title: NUHW
open-graph: 
    title: NUHW Union Elections
    description: Data on recent union elections in NUHW.
---
...
library(gt)
library(here)
data <- read_csv("NUHW_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
