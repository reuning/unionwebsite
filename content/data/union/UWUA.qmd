...
title: UWUA
open-graph: 
    title: UWUA Union Elections
    description: Data on recent union elections in UWUA.
---
...
library(gt)
library(here)
data <- read_csv("UWUA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
