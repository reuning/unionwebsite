...
title: ACOPS
open-graph: 
    title: ACOPS Union Elections
    description: Data on recent union elections in ACOPS.
---
...
library(gt)
library(here)
data <- read_csv("ACOPS_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
