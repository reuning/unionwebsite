...
title: PATCO
open-graph: 
    title: PATCO Union Elections
    description: Data on recent union elections in PATCO.
---
...
library(gt)
library(here)
data <- read_csv("PATCO_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
