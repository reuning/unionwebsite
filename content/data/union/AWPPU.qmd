...
title: AWPPU
open-graph: 
    title: AWPPU Union Elections
    description: Data on recent union elections in AWPPU.
---
...
library(gt)
library(here)
data <- read_csv("AWPPU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
