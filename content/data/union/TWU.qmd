...
title: TWU
open-graph: 
    title: TWU Union Elections
    description: Data on recent union elections in TWU.
---
...
library(gt)
library(here)
data <- read_csv("TWU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
