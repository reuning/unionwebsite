...
title: USPOA
open-graph: 
    title: USPOA Union Elections
    description: Data on recent union elections in USPOA.
---
...
library(gt)
library(here)
data <- read_csv("USPOA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
