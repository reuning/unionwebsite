...
title: UMWA
open-graph: 
    title: UMWA Union Elections
    description: Data on recent union elections in UMWA.
---
...
library(gt)
library(here)
data <- read_csv("UMWA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
