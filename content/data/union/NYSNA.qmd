...
title: NYSNA
open-graph: 
    title: NYSNA Union Elections
    description: Data on recent union elections in NYSNA.
---
...
library(gt)
library(here)
data <- read_csv("NYSNA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
