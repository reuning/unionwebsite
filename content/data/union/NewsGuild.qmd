...
title: NewsGuild
open-graph: 
    title: NewsGuild Union Elections
    description: Data on recent union elections in NewsGuild.
---
...
library(gt)
library(here)
data <- read_csv("NewsGuild_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-NewsGuild
