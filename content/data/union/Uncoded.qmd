...
title: Uncoded
open-graph: 
    title: Uncoded Union Elections
    description: Data on recent union elections in Uncoded.
---
...
library(gt)
library(here)
data <- read_csv("Uncoded_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
