...
title: PASNAP
open-graph: 
    title: PASNAP Union Elections
    description: Data on recent union elections in PASNAP.
---
...
library(gt)
library(here)
data <- read_csv("PASNAP_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
