...
title: Other
open-graph: 
    title: Other Union Elections
    description: Data on recent union elections in Other.
---
...
library(gt)
library(here)
data <- read_csv("Other_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
