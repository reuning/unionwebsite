...
title: Seafarers
open-graph: 
    title: Seafarers Union Elections
    description: Data on recent union elections in Seafarers.
---
...
library(gt)
library(here)
data <- read_csv("Seafarers_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-Seafarers
