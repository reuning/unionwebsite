...
title: NABET
open-graph: 
    title: NABET Union Elections
    description: Data on recent union elections in NABET.
---
...
library(gt)
library(here)
data <- read_csv("NABET_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
