...
title: IUOE
open-graph: 
    title: IUOE Union Elections
    description: Data on recent union elections in IUOE.
---
...
library(gt)
library(here)
data <- read_csv("IUOE_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
