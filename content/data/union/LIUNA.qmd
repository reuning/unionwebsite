...
title: LIUNA
open-graph: 
    title: LIUNA Union Elections
    description: Data on recent union elections in LIUNA.
---
...
library(gt)
library(here)
data <- read_csv("LIUNA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
