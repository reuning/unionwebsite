...
title: UNAP
open-graph: 
    title: UNAP Union Elections
    description: Data on recent union elections in UNAP.
---
...
library(gt)
library(here)
data <- read_csv("UNAP_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
