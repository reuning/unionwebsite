...
title: UFCW
open-graph: 
    title: UFCW Union Elections
    description: Data on recent union elections in UFCW.
---
...
library(gt)
library(here)
data <- read_csv("UFCW_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
