...
title: CWA
open-graph: 
    title: CWA Union Elections
    description: Data on recent union elections in CWA.
---
...
library(gt)
library(here)
data <- read_csv("CWA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
