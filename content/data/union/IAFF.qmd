...
title: IAFF
open-graph: 
    title: IAFF Union Elections
    description: Data on recent union elections in IAFF.
---
...
library(gt)
library(here)
data <- read_csv("IAFF_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
