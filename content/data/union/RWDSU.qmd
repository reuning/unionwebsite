...
title: RWDSU
open-graph: 
    title: RWDSU Union Elections
    description: Data on recent union elections in RWDSU.
---
...
library(gt)
library(here)
data <- read_csv("RWDSU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
