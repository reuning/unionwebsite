...
title: IATSE
open-graph: 
    title: IATSE Union Elections
    description: Data on recent union elections in IATSE.
---
...
library(gt)
library(here)
data <- read_csv("IATSE_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
