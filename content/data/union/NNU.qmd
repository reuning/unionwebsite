...
title: NNU
open-graph: 
    title: NNU Union Elections
    description: Data on recent union elections in NNU.
---
...
library(gt)
library(here)
data <- read_csv("NNU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
