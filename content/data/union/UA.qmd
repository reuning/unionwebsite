...
title: UA
open-graph: 
    title: UA Union Elections
    description: Data on recent union elections in UA.
---
...
library(gt)
library(here)
data <- read_csv("UA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
