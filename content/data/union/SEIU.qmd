...
title: SEIU
open-graph: 
    title: SEIU Union Elections
    description: Data on recent union elections in SEIU.
---
...
library(gt)
library(here)
data <- read_csv("SEIU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
