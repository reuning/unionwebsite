...
title: WU
open-graph: 
    title: WU Union Elections
    description: Data on recent union elections in WU.
---
...
library(gt)
library(here)
data <- read_csv("WU_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
