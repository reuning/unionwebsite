...
title: BCTGM
open-graph: 
    title: BCTGM Union Elections
    description: Data on recent union elections in BCTGM.
---
...
library(gt)
library(here)
data <- read_csv("BCTGM_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
