...
title: SSOBA
open-graph: 
    title: SSOBA Union Elections
    description: Data on recent union elections in SSOBA.
---
...
library(gt)
library(here)
data <- read_csv("SSOBA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
