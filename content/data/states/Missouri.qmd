...
title: Missouri
open-graph: 
    title: Missouri Union Elections
...
library(gt)
library(here)
data <- read_csv("MO_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
