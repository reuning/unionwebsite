...
open-graph: 
    title: North Carolina Union Elections
...
library(gt)
library(here)
data <- read_csv("NC_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-North Carolina
...
```{r}
#| label: worker-outcome-North Carolina
...
```{r}
#| label: newly-covered-North Carolina
