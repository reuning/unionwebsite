...
title: Massachusetts
open-graph: 
    title: Massachusetts Union Elections
...
library(gt)
library(here)
data <- read_csv("MA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-Massachusetts
...
```{r}
#| label: worker-outcome-Massachusetts
...
```{r}
#| label: newly-covered-Massachusetts
