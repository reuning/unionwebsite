...
title: Rhode Island
open-graph: 
    title: Rhode Island Union Elections
...
library(gt)
library(here)
data <- read_csv("RI_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-Rhode Island
...
```{r}
#| label: worker-outcome-Rhode Island
...
```{r}
#| label: newly-covered-Rhode Island
