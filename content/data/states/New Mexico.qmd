...
title: New Mexico
open-graph: 
    title: New Mexico Union Elections
...
library(gt)
library(here)
data <- read_csv("NM_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-New Mexico
...
```{r}
#| label: newly-covered-New Mexico
