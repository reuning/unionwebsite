...
title: Maryland
open-graph: 
    title: Maryland Union Elections
...
library(gt)
library(here)
data <- read_csv("MD_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
