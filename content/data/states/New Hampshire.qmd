...
title: New Hampshire
open-graph: 
    title: New Hampshire Union Elections
...
library(gt)
library(here)
data <- read_csv("NH_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-New Hampshire
...
```{r}
#| label: worker-outcome-New Hampshire
...
```{r}
#| label: newly-covered-New Hampshire
