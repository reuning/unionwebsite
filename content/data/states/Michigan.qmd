...
title: Michigan
open-graph: 
    title: Michigan Union Elections
...
library(gt)
library(here)
data <- read_csv("MI_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
