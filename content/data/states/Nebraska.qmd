...
title: Nebraska
open-graph: 
    title: Nebraska Union Elections
...
library(gt)
library(here)
data <- read_csv("NE_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
