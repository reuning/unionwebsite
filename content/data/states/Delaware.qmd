...
title: Delaware
open-graph: 
    title: Delaware Union Elections
...
library(gt)
library(here)
data <- read_csv("DE_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
