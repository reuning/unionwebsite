...
title: North Dakota
open-graph: 
    title: North Dakota Union Elections
...
library(gt)
library(here)
data <- read_csv("ND_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-North Dakota
...
```{r}
#| label: worker-outcome-North Dakota
...
```{r}
#| label: newly-covered-North Dakota
