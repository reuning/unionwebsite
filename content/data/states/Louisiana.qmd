...
title: Louisiana
open-graph: 
    title: Louisiana Union Elections
...
library(gt)
library(here)
data <- read_csv("LA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-Louisiana
