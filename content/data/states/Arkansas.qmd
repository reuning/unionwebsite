...
title: Arkansas
open-graph: 
    title: Arkansas Union Elections
...
library(gt)
library(here)
data <- read_csv("AR_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
