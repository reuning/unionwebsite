...
title: Oklahoma
open-graph: 
    title: Oklahoma Union Elections
...
library(gt)
library(here)
data <- read_csv("OK_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
