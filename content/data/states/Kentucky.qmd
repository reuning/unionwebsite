...
title: Kentucky
open-graph: 
    title: Kentucky Union Elections
...
library(gt)
library(here)
data <- read_csv("KY_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
