...
title: Pennsylvania
open-graph: 
    title: Pennsylvania Union Elections
...
library(gt)
library(here)
data <- read_csv("PA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-Pennsylvania
...
```{r}
#| label: worker-outcome-Pennsylvania
...
```{r}
#| label: newly-covered-Pennsylvania
