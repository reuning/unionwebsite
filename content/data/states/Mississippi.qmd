...
title: Mississippi
open-graph: 
    title: Mississippi Union Elections
...
library(gt)
library(here)
data <- read_csv("MS_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-Mississippi
...
```{r}
#| label: worker-outcome-Mississippi
...
```{r}
#| label: newly-covered-Mississippi
