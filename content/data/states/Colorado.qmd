...
title: Colorado
open-graph: 
    title: Colorado Union Elections
...
library(gt)
library(here)
data <- read_csv("CO_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
