...
title: New Jersey
open-graph: 
    title: New Jersey Union Elections
...
library(gt)
library(here)
data <- read_csv("NJ_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-New Jersey
...
```{r}
#| label: newly-covered-New Jersey
