...
title: Illinois
open-graph: 
    title: Illinois Union Elections
...
library(gt)
library(here)
data <- read_csv("IL_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
