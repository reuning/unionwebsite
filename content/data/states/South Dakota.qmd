...
title: South Dakota
open-graph: 
    title: South Dakota Union Elections
...
library(gt)
library(here)
data <- read_csv("SD_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-South Dakota
...
```{r}
#| label: worker-outcome-South Dakota
...
```{r}
#| label: newly-covered-South Dakota
