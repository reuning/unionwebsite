...
title: Minnesota
open-graph: 
    title: Minnesota Union Elections
...
library(gt)
library(here)
data <- read_csv("MN_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-Minnesota
