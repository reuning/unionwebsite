...
title: New York
open-graph: 
    title: New York Union Elections
...
library(gt)
library(here)
data <- read_csv("NY_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
