...
title: California
open-graph: 
    title: California Union Elections
...
library(gt)
library(here)
data <- read_csv("CA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-California
...
```{r}
#| label: newly-covered-California
