...
title: Washington
open-graph: 
    title: Washington Union Elections
...
library(gt)
library(here)
data <- read_csv("WA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-Washington
...
```{r}
#| label: newly-covered-Washington
