...
title: Connecticut
open-graph: 
    title: Connecticut Union Elections
...
library(gt)
library(here)
data <- read_csv("CT_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-Connecticut
...
```{r}
#| label: worker-outcome-Connecticut
...
```{r}
#| label: newly-covered-Connecticut
