...
title: West Virginia
open-graph: 
    title: West Virginia Union Elections
...
library(gt)
library(here)
data <- read_csv("WV_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-West Virginia
...
```{r}
#| label: worker-outcome-West Virginia
...
```{r}
#| label: newly-covered-West Virginia
