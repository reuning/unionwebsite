...
open-graph: 
    title: South Carolina Union Elections
...
library(gt)
library(here)
data <- read_csv("SC_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-South Carolina
...
```{r}
#| label: worker-outcome-South Carolina
...
```{r}
#| label: newly-covered-South Carolina
