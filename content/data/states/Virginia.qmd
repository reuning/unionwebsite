...
title: Virginia
open-graph: 
    title: Virginia Union Elections
...
library(gt)
library(here)
data <- read_csv("VA_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
