...
title: Tennessee
open-graph: 
    title: Tennessee Union Elections
...
library(gt)
library(here)
data <- read_csv("TN_data.csv") |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
```{r}
#| label: worker-outcome-Tennessee
