---
title: {{< template Union_Short >}}
pagetitle: {{< template Union_Short >}} Union Elections
hide-description: true 
description: Data on recent union elections in {{< template Union_Short >}}.
---
...
library(gt)
library(here)
data <- read_csv({{< template data_filename >}}) |> filter(Case_Type == "RC") |> 
  mutate(Ballot_Type= 
...
#| label: unit-outcome-{{< template Union_Short >}}
...
```{r}
#| label: worker-outcome-{{< template Union_Short >}}
...
```{r}
#| label: newly-covered-{{< template Union_Short >}}
...
```{r}
#| label: timline-{{< template Union_Short >}}
